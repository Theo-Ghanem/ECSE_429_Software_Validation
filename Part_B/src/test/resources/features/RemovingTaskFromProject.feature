...
Scenario Outline: Removing a specific task from a project that is linked to multiple tasks
    ...
    Then only the task <project_task22> should remain in the project_tasks field of the project <project_title2>
    Examples:
...
Scenario Outline: Attempting to remove a task from a project that is not associated with it
    ...
    When the user attempts to remove <project_task3> from the unassociated project titled <project_title3>
